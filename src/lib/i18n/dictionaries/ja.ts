...
const dict: typeof ko = {
  ...
  landing: {
    ...
    process: {
      ...
      steps: [
        ...
        { n: "03", t: "本契約・拡大", d: "自治体アプリブランディング後、全エリアへ展開" },
      ],
      stepLabel: "STEP",
    },
    ...
    cta: {
      ...
      form: {
        ...
        message: "お問い合わせ内容 (任意)",
        submit: "導入のお問い合わせを送る",
        success: "お問い合わせを受け付けました。営業日1日以内にご返信いたします。",
  ...
  auth: {
    ...
    login: {
      ...
      forgotPage: {
        title: "パスワードの再設定",
        desc: "ご登録のメールアドレスを入力してください。パスワード再設定リンクをお送りします。",
        labelEmail: "メールアドレス",
        placeholderEmail: "メールアドレスを入力",
        submit: "再設定リンクを送る",
        successTitle: "メールをご確認ください",
        successDesc: "入力されたメールアドレスにパスワード再設定リンクをお送りしました。リンクは1時間有効です。",
        backToLogin: "ログインに戻る",
      ...
      resetPage: {
        ...
        labelConfirm: "パスワードの確認",
        placeholderConfirm: "パスワードを再入力",
        submit: "パスワードを変更",
        successTitle: "パスワードを変更しました",
        successDesc: "新しいパスワードでログインしてください。",
        backToLogin: "ログインに戻る",
        invalidToken: "リンクの有効期限が切れているか、無効です。再度お試しください。",
        mismatch: "パスワードが一致しません。",
        weak: "パスワードは8文字以上で入力してください。",
      },
      labelOtp: "認証コード (OTP)",
  ...
  dashboard: {
    ...
    critical: {
      ...
      actionModal: {
        ...
        noteLabel: "備考",
        notePlaceholder: "対応内容を入力してください...",
        save: "保存",
        saving: "保存中...",
        cancel: "キャンセル",
        successMsg: "対応が記録されました。",
        errorServer: "サーバーエラーが発生しました。",
        history: "対応履歴",
        noHistory: "対応履歴はありません。",
        actor: "対応者",
      },
    },
    activity: {
    ...
    testConnection: {
      title: "設定確認",
      desc: "対象者がアプリから設定確認をリクエストした結果です。",
      empty: "まだ設定確認のリクエストはありません。",
    },
  },
  ...
  users: {
    ...
    addModal: {
      ...
      checkinMode: "チェックイン方式",
      checkinModeManual: "タップして手動",
      checkinModeAppOpen: "アプリを開くと自動",
      checkinModePassive: "スマホ使用時に自動",
      interval: "チェックイン周期",
      intervalSuffix: "時間",
      cancel: "キャンセル",
      submit: "登録",
  ...
  managers: {
    ...
    deleteConfirm: {
      title: "運営者削除",
      body: "選択した運営者を削除します。この操作は元に戻せません。",
      confirm: "削除",
      deleting: "削除中...",
      cancel: "キャンセル",
      errorServer: "サーバーと通信できません。",
  ...
  myProfile: {
    ...
    pwSave: "変更",
    pwSaving: "変更中...",
    pwSuccess: "パスワードが変更されました。",
    errorMismatch: "新しいパスワードが一致しません。",
    errorLength: "パスワードは8文字以上にしてください。",
    errorServer: "サーバーと通信できません。",
  },

  reports: {
    title: "月次レポート",
    desc: (year: number, month: number) => `${year}年${month}月 自動集計レポート`,
    generatedAt: "作成日",
    period: "報告期間",
    btnPrint: "印刷 / PDF保存",
    btnPrev: "← 前の月",
  ...
  settings: {
    ...
    checkinDefaults: {
      title: "チェックイン基本設定",
      desc: "新しい対象者を登録する際に基本適用されるチェックイン方式・周期です。登録時に個別修正できます。",
      mode: "チェックイン方式",
      modeManual: "タップして手動",
      modeAppOpen: "アプリを開くと自動",
      modePassive: "スマホ使用時に自動",
      interval: "チェックイン周期",
      intervalSuffix: "時間",
      save: "保存",
      saving: "保存中...",
  ...
  userDetail: {
    ...
    labelContact: "緊急連絡先",
    labelCaseworker: "担当者",
    labelLastCheckin: "直近チェックイン",
    labelInterval: "チェックイン周期",
    intervalSuffix: "時間",
    labelCheckinMode: "チェックイン方式",
    checkinModeManual: "タップして手動",
    checkinModeAppOpen: "アプリを開くと自動",
    checkinModePassive: "スマホ使用時に自動",
    noCheckin: "チェックインなし",
    unassigned: "未配置",
    actionTitle: "対応記録",
    actionDesc: "この対象者への電話・訪問・SMS等の対応履歴を記録・確認します。",
    btnAddAction: "対応記録を追加",
    noActionLog: "対応記録がありません。",
    actionTypes: {
      visit: "現地訪問",
      call: "電話対応",
      sms: "SMS送信",
